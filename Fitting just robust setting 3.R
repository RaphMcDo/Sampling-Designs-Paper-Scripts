...
rob_list<-list()
for (sub in 1:20){
  load(paste0("sub_data_list_set_3_",sub,"RData"))
  for (n in 1:nrep){
  ...
  save(rob_list,file=paste0("rob_fit_set_3_fixed_",sub,".RData"))
}
...
for (sub in 1:20){
  ...
  save(rob_list,file=paste0("rob_fit_set_3_strat_",sub,".RData"))
}
